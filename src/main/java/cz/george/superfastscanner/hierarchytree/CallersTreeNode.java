...
/**
 * It's so fast that only 100% Method Call Hierarchy is recursively generated when Constructor is called...
 */
public class CallersTreeNode {
     ...
     */
    boolean isMethodCalledYet(Method method) {
        // Walk right into the root-1
        if (this.parrent != null) {
            boolean isNullYet = this.parrent.isMethodCalledYet(method);
